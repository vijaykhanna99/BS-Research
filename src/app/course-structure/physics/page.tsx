...
const physicsData = {
    ...
    electives: [
        [
            ...
            { code: "IN 203", name: "Micro to Quantum Supercapacitor Devices", credits: "3:0" },
            { code: "IN 204", name: "Basic Instrumentation Laboratory", credits: "0:3" },
            ...
            { code: "IN 210", name: "Wave propagation in periodic media", credits: "3:0" },
            { code: "IN 212", name: "Advanced Nano/Micro System", credits: "3:0" },
            { code: "IN 212", name: "Advanced Nano/Micro Systems", credits: "3:0" },
            ...
            { code: "IN 252", name: "Optical materials and devices", credits: "3:0" },
            ...
            { code: "IN 277", name: "Instrumentation Electronics Laboratory", credits: "2:1" },
            { code: "IN 278", name: "Introduction to Embedded Systems", credits: "2:1" },
            { code: "IN 279", name: "RF networks and Systems", credits: "2:1" },
            ...
            { code: "IN 303", name: "Concepts of Terahertz Communication", credits: "3:0" },
            { code: "IN 305", name: "Optical Instrumentation Lab 2", credits: "0:3" },
            { code: "IN 321", name: "Instrumentation Systems Laboratory", credits: "0:3" },
