...
const chemistryData = {
    ...
    electives: [
        [
            ...
            { code: "IP 327", name: "Chemical Dynamics", credits: "3:0" },
            { code: "IP 328", name: "Astrochemistry", credits: "3:0" },
            { code: "IP 330", name: "Group Theory and Molecular Spectroscopy", credits: "3:0" },
            ...
            { code: "MR 309", name: "Introduction to Supramolecular Chemistry.", credits: "3:0" },
            { code: "MR 310", name: "Light Emitting Materials and Devices", credits: "3:0" },
            ...
            { code: "SS 303", name: "Functional Molecular Materials : Theory and Applications", credits: "3:0" },
