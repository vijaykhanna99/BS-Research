...
const earthScienceData = {
    ...
    electives: [
        [
            ...
            { code: "UM 204", name: "Introduction to Basic Analysis", credits: "3:1" },
            { code: "UM 205", name: "Introduction To Algebraic Structures", credits: "3:1" },
            ...
            { code: "AS 215", name: "Environmental Fluid Dynamics", credits: "3:0" },
            { code: "AS 216", name: "Introduction to climate system", credits: "3:0" },
            { code: "AS 217", name: "Modelling and Forecasting", credits: "2:1" },
            ...
            { code: "CE 221 /CE 233", name: "Earthquake Geotechnical Engineering", credits: "3:0" },
            ...
            { code: "ST 201", name: "Thermochemical and Biology Energy Recovery from Biomass", credits: "3:0" },
            { code: "ST 202", name: "Energy Systems and Sustainability", credits: "3:0" },
            { code: "ST 203", name: "Design, Technology and Sustainability", credits: "3:0" },
            { code: "ST 204", name: "Sustainable Energy and Environment lab", credits: "1:1" },
            { code: "ST 206", name: "Environmental and Natural Resources Management", credits: "2:1" },
            { code: "ST 207", name: "Alternate Fuels for Reciprocating Engines", credits: "2:0" },
            { code: "ST 207", name: "Alternate Fuels for Reciprocating Engines", credits: "2:1" },
            { code: "ST 207", name: "Alternate Fuels for Reciprocating Engines", credits: "3:0" },
            { code: "ST 209", name: "Society and Technology", credits: "2:0" },
            { code: "ST 209", name: "Society and Technology", credits: "3:0" },
            ...
            { code: "ST 217", name: "Field hydrology, river engineering and basin studies", credits: "3:1" },
            { code: "ST 218", name: "Sustainable Wastewater Management", credits: "3:0" },
            { code: "ST 219", name: "Separation Technologies for Sustainable Industrial Processes", credits: "3:0" },
            { code: "ST 221", name: "Concrete Technology: fundamentals and sustainable practices", credits: "3:0" },
            { code: "ST 222", name: "Basic Concepts of Planning and Design of Hydro-Mechanical Components in Dam", credits: "3:0" },
            { code: "ST 223", name: "Green Catalysis in Chemical Industries", credits: "3:0" },
            { code: "ST 224", name: "Renewable energy", credits: "3:0" },
            { code: "ST 225", name: "Sustainable Materials", credits: "3:0" },
            { code: "ST 226", name: "Sustainable Water Management", credits: "3:0" },
            { code: "ST 227", name: "Environmental Analytical Chemistry", credits: "2:1" },
            { code: "ST 228", name: "Data Analysis, Machine Learning and Artificial Int", credits: "3:0" },
            { code: "ST 229", name: "Low-carbon infrastructure", credits: "3:0" },
            { code: "ST 230", name: "Ecology, Climate,and the Built Environment", credits: "3:0" },
